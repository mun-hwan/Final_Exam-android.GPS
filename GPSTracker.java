...
public class GPSTracker extends Service implements LocationListener {
    ...
    private static final long MIN_TIME_BW_UPDATES = 1000 * 60 * 1; // 7seconds
    ...
    public void onProviderDisabled(String provider) {
        ...
        mHandler.sendEmptyMessage(com.example.user.final_exam.MapsActivity.RENEW_GPS);
    ...
    private void sendString(String str){
        ...
        msg.what = com.example.user.final_exam.MapsActivity.SEND_PRINT;
